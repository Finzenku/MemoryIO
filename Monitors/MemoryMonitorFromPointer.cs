namespace MemoryIO.Monitors
{
    ...
    /// </summary>
    public class MemoryMonitorFromPointer : IMemoryMonitor<MemoryRegionChangedEventArgs>, IDisposable
    {
        /// <summary>
        ...
        public MemoryMonitorFromPointer(IMemoryIO memoryManager, IntPtr pointerAddress, int regionSize, int pointerOffset = 0, int pollingRateInMilliseconds = 10)
        {
